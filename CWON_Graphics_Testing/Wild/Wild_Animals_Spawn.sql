...
INSERT INTO UnitSpawnFeatures SELECT 'UNIT_ANIMAL_AMERICANCROCODILE', FeatureType FROM Features WHERE FeatureType = 'FEATURE_FLOODPLAINS_GRASSLAND';
INSERT INTO UnitSpawnFeatures SELECT 'UNIT_ANIMAL_AMERICANCROCODILE', FeatureType FROM Features WHERE FeatureType = 'FEATURE_FLOODPLAINS_PLAINS';
INSERT INTO UnitSpawnFeatures SELECT 'UNIT_ANIMAL_FRESHWATER_CROCODILE', FeatureType FROM Features WHERE FeatureType = 'FEATURE_FLOODPLAINS_GRASSLAND';
INSERT INTO UnitSpawnFeatures SELECT 'UNIT_ANIMAL_FRESHWATER_CROCODILE', FeatureType FROM Features WHERE FeatureType = 'FEATURE_FLOODPLAINS_PLAINS';
INSERT INTO UnitSpawnFeatures SELECT 'UNIT_ANIMAL_NILE_CROCODILE', FeatureType FROM Features WHERE FeatureType = 'FEATURE_FLOODPLAINS_GRASSLAND';
INSERT INTO UnitSpawnFeatures SELECT 'UNIT_ANIMAL_NILE_CROCODILE', FeatureType FROM Features WHERE FeatureType = 'FEATURE_FLOODPLAINS_PLAINS';