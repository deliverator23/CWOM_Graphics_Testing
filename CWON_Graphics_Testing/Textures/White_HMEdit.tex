...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\3D\Civ5_Wonders_Modbuddy\Modbuddy\Neuschwanstein\White_HMEdit.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>318072284</m_ExportedTime>
	<m_ClassName text="Terrain_EditHeightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="White_HMEdit.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="White_HMEdit"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
