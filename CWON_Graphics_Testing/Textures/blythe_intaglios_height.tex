...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\3D\Wonders\Blythe_Intaglios\blythe_intaglios_height.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1073732834</m_ExportedTime>
	<m_ClassName text="Decal_Heightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="blythe_intaglios_height.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="blythe_intaglios_height"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
